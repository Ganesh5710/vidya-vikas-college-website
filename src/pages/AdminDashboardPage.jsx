...
export const AdminDashboardPage = () => {
    ...
    const [newTopperSession, setNewTopperSession] = useState('2024-2025');
    ...
    const handleSaveTopper = (e) => {
        ...
        const sessionYear = newTopperSession ? `${newTopperSession} BIEAP ${newTopperYear}` : (newTopperYear === '1st Year' ? '2024-2025 BIEAP Junior Inter' : '2024-2025 BIEAP Senior Inter');
    ...
    const handleStartEditTopper = (item) => {
        ...
        setNewTopperSession(item.yearSession ? item.yearSession.split(' ')[0] : '2024-2025');
      ...
      {activeTab === 'results' && (<section className="space-y-6">
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
            ...
            <form onSubmit={handleSaveTopper} className="space-y-4">
              {/* Row 1: Academic Year Class, Exam Session Year, Student Name, Roll Number */}
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <input type="text" required placeholder="e.g. 2024-2025" value={newTopperSession} onChange={(e) => setNewTopperSession(e.target.value)} className="w-full px-3.5 py-2.5 rounded-lg border border-slate-300 text-xs text-slate-900 focus:ring-2 focus:ring-maroon-800 outline-none font-semibold"/>
                </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="space-y-0.5">
                        <div className="flex flex-wrap items-center gap-1.5">
                          ...
                          <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-maroon-900 text-white">{top.academicYear || '1st Year'}</span>
                          <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded bg-slate-200 text-slate-800">{top.yearSession || '2024-2025'}</span>
                        </div>
