...
export const MobileQuickActionsFAB: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3 print:hidden">
        ...
        {isOpen && (
          <div className="bg-white rounded-2xl p-5 shadow-2xl border border-slate-200 w-80 sm:w-96 space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="space-y-2">
              {quickTemplates.map((template, idx) => (
                <button
                  ...
                  className="w-full p-2.5 rounded-xl bg-white hover:bg-emerald-50 border border-slate-200 hover:border-emerald-300 text-left text-xs text-slate-700 font-medium transition-colors flex items-center justify-between group"
                >
                  <span>{template}</span>
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center gap-2">
              <a
                href={`tel:${phoneNumClean}`}
                className="flex-1 py-2 px-3 rounded-xl bg-navy-900 hover:bg-navy-950 text-white text-xs font-bold flex items-center justify-center gap-2 shadow"
              >
              ...
              <a
                ...
                className="flex-1 py-2 px-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-navy-950 text-xs font-bold flex items-center justify-center gap-2 shadow"
              >
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href={`tel:${phoneNumClean}`}
            className="p-3.5 rounded-full bg-navy-900 hover:bg-navy-950 text-white shadow-xl flex items-center justify-center transition-transform hover:scale-110 border-2 border-white"
            title="Call Admissions Desk Now"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3.5 rounded-full bg-amber-500 hover:bg-amber-400 text-navy-950 shadow-xl flex items-center justify-center transition-transform hover:scale-110 border-2 border-white"
            title="Get Google Maps Campus Directions"
          >
          ...
          <button
            ...
            className="p-3.5 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white shadow-2xl flex items-center justify-center transition-transform hover:scale-110 border-2 border-white relative group"
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-navy-950/95 backdrop-blur-md border-t border-navy-800 p-2 text-white flex items-center justify-around shadow-2xl print:hidden">
        <a
          href={`tel:${phoneNumClean}`}
          className="flex flex-col items-center gap-0.5 text-[10px] font-bold text-amber-400 hover:text-white"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center gap-0.5 text-[10px] font-bold text-white hover:text-amber-400"
        >
        ...
        <button
          ...
          className="flex flex-col items-center gap-0.5 text-[10px] font-bold text-emerald-400 hover:text-white"
        >
        ...
        <a
          ...
          className="px-3 py-1.5 rounded-lg bg-maroon-900 text-amber-400 text-[10px] font-extrabold flex items-center gap-1 shadow"
        >
