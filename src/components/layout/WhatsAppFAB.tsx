  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3">
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white shadow-xl flex items-center justify-center transition-transform hover:scale-110 border-2 border-white focus:outline-none"
        title="Chat on WhatsApp with Admissions Desk"
      >
        {isOpen ? (
          <X className="w-6 h-6" />
        ) : (
